package com.cr.insurance.productiveInquiry.entity;

import java.util.Date;

import com.cr.insurance.common.entity.BaseEntity;

public class ProductiveInquiry extends BaseEntity{
	...
	public String toString() {
		return "ProductiveInquiry [name=" + name + ", address=" + address + ", postalcode=" + postalcode + ", type="
